export class QuadrilateralTessellation {
}
QuadrilateralTessellation.DefaultSlice = 36;
...
export var SubdivisionMethod;
(function (SubdivisionMethod) {
    SubdivisionMethod[SubdivisionMethod["CatmullClark"] = 0] = "CatmullClark";
    SubdivisionMethod[SubdivisionMethod["DooSabin"] = 1] = "DooSabin";
    SubdivisionMethod[SubdivisionMethod["Loop4"] = 2] = "Loop4";
})(SubdivisionMethod || (SubdivisionMethod = {}));
export class PolyhedronTessellation {
}
PolyhedronTessellation.DefaultMethod = SubdivisionMethod.Loop4;
PolyhedronTessellation.DefaultBase = PlatonicSolids.icosahedron;
PolyhedronTessellation.DefaultLevel = 4;
export class MeshFactory {
    ...
    static Tessellate(shape, tessellation) {
        shape = shape || {};
        /* first create the base. */
        let base = tessellation ? tessellation.base || PolyhedronTessellation.DefaultBase : PolyhedronTessellation.DefaultBase;
        switch (base) {
    ...
    static _getMiddlePoint(shape, p1, p2, map) {
    ...
    static CreateEllipsoid(shape, options, tessellation) {
        shape = shape || {};
