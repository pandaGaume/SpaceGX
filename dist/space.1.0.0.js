...
/* harmony import */ var _MeshProcessor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MeshProcessor */ "./src/build/Geometry/MeshProcessor.js");
    ...
    */
    ...
    static GreateGeodesicGrid(shape, radius, a = MeshFactory.DefaultSubdivisionLevelA) {
        ...
        for (let fi = 0; fi !== n;) {
            ...
            let vedge0 = _MeshProcessor__WEBPACK_IMPORTED_MODULE_0__["MeshProcessor"].DivideEdge(shape, p1, p0, a, radius, map);
            let vedge1 = _MeshProcessor__WEBPACK_IMPORTED_MODULE_0__["MeshProcessor"].DivideEdge(shape, p1, p2, a, radius, map);
            let hedges = vedge0.map((value, index, array) => _MeshProcessor__WEBPACK_IMPORTED_MODULE_0__["MeshProcessor"].DivideEdge(shape, value, vedge1[index], index, radius, undefined));
            let row0, row1;
            for (let i = 0; i != a;) {
                row0 = hedges[i++];
                row1 = hedges[i];
            ...
            if (a > 1) {
                ...
                for (let i = 1; i != a; i++) {
                    ...
                    */
                    ...
                    v = _Math__WEBPACK_IMPORTED_MODULE_0__["Scalar"].WithinEpsilon(v, 1) ? 1 : v; // avoid artifact
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Mesh__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Mesh */ "./src/build/Geometry/Mesh.js");
/* empty/unused harmony star reexport *//* harmony import */ var _MeshFactory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MeshFactory */ "./src/build/Geometry/MeshFactory.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PlatonicSolids", function() { return _MeshFactory__WEBPACK_IMPORTED_MODULE_1__["PlatonicSolids"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MeshFactory", function() { return _MeshFactory__WEBPACK_IMPORTED_MODULE_1__["MeshFactory"]; });

/* harmony import */ var _MeshProcessor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MeshProcessor */ "./src/build/Geometry/MeshProcessor.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "MeshProcessor", function() { return _MeshProcessor__WEBPACK_IMPORTED_MODULE_2__["MeshProcessor"]; });
...
/*!***************************!*\
  !*** ./src/build/Math.js ***!
  \***************************/
/*! exports provided: Scalar, AbstractRange, Range */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/build/index.js ***!
  \****************************/
/*! exports provided: EventEmitter, Scalar, AbstractRange, Range, Unit, Quantity, QuantityRange, Timespan, Temperature, Mass, Power, Voltage, Current, Luminosity, Volume, Angle, Distance, RGBAColor, HSLColor, PlatonicSolids, MeshFactory, MeshProcessor, CelestialNodeType, MorganKeenanClass, SpectralClass, StarColor, AxialTilt, BabylonMeshExporter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Scalar", function() { return _Math__WEBPACK_IMPORTED_MODULE_1__["Scalar"]; });
